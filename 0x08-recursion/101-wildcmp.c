...
/**
 * widcmp - compares two strings recursively,
...
{
	/**
	 * this is the sum of return values
	 */
	 ...
	 * if we reached the end s1, return 1
	 ...
	 * convert non-zero to 1, kees 0 at 0, return
	 */
